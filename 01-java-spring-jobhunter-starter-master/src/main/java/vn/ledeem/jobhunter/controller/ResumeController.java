...
import vn.ledeem.jobhunter.domain.response.resume.ResCreateResumeDTO;
import vn.ledeem.jobhunter.domain.response.resume.ResFetchResumeDTO;
import vn.ledeem.jobhunter.domain.response.resume.ResUpdateResumeDTO;
import vn.ledeem.jobhunter.service.ResumeService;
...
public class ResumeController {
    ...
    public ResponseEntity<ResCreateResumeDTO> create(@Valid @RequestBody Resume resume) throws IdInvalidException {
        ...
        if (!isIdExist) { // Giả định ý bạn là kiểm tra KHÔNG tồn tại
            throw new IdInvalidException("User id/Job id không tồn tại"); // Sửa lỗi cú pháp `message:`
        }
